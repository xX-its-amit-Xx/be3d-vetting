...
**What BE3D got right (a genuine, orthogonal win).** From screen signal alone it robustly flagged the **RING Zn-coordinating residue C64** (loss-of-function in Findlay SGE, pathogenic in ClinVar) — and notably **AlphaMissense mis-calls C64G/C64R as *likely benign*** (0.09–0.11), a real predictor blind spot that the functional-screen signal rescues. It also recovered a **coherent BRCT loss-of-function core** (H1686/V1687/D1692, R1751/A1752/R1753 — all Findlay-LOF) and the BARD1-interface helix (89–95). More broadly it concentrates hits on the folded **RING (2–109) and BRCT (1642–1855)** domains at ~2.4–3.8× the rate of the disordered central region — i.e., it is not "flagging everything" (genome-wide significant-residue rate ~7%).
